Shader "Ocean/Ocean"
{
    Properties
    {
        ...
        // surface
        [Tab(Tabs Surface)]
        [ToggleOff(_RECEIVE_SHADOWS_OFF)] _ReceiveShadows("Receive Shadows", Float) = 0
        ...
        [TitleGroup(. Subsurface_Scattering, true)]
