...
/// <summary>
/// Represents a colony of one species of coral that can grow. Instantiates one coral on initialization.
/// </summary>
public class CoralColony {
    CoralSpecies species;
    List<GameObject> corals = new List<GameObject>();
    public GameObject gameObject;
    TerrainGenerator terrainGenerator;
    CoralSpawner coralSpawner;
    ...
    public CoralColony(CoralSpecies species, Vector3 startingLocation, TerrainGenerator terrainGenerator) {
